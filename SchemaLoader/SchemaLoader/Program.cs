...
configuration.SetBasePath(AppContext.BaseDirectory); // Set the base path
configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true); // Load appsettings.json
